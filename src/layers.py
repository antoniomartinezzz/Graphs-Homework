...
class MeanAggregator(Aggregator):
    ...
    def _aggregate(self, features):
        ...
        Returns
        -------
        Aggregated feature (torch.Tensor)
        """

        #################### your code here ###################
        #TODO: implement the features aggregator function for the MeanAggregator
        #######################################################
        aggregation = 0
...
class PoolAggregator(Aggregator):
    ...
    def __init__(self, input_dim, output_dim, device='cpu'):
        ...
        #################### your code here ###################
        #TODO: implement de the pooling aggregator layers as explained in the GraphSAGE paper.
        # Note that the the max or mean operators are already implemented in the subclasses below  
        #######################################################

        #self.fc1 =  #fully connected layer 
        #self.activation =  #nonlinear activation function
    ...
    def _aggregate(self, features):
        ...
        out = self.activation(self.fc1(features))
